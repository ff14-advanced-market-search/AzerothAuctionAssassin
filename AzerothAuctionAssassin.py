...
class App(QMainWindow):
    ...
    def import_pbs_pet_ilvl_data(self):
        """
        Import PBS pet data and convert to pet level trading rules.
        
        Allows users to paste Pet Battle System (PBS) data to generate automated pet trading rules. Parses complex input data, extracts pet names and prices, and creates trading rules with flexible parsing and fallback mechanisms.
        
        Parameters:
            None (uses self context and internal state)
        
        Functionality:
            - Opens a multi-line input dialog for PBS pet data entry
            - Parses pasted data to extract pet names and prices
        ...
        Notes:
            - Supports flexible data parsing with semicolon-separated fields
    ...
    def import_pbs_pet_data(self):
        ...
        The function opens a multi-line input dialog where users can paste PBS pet data. It parses the input,
        extracting pet names and prices, matches them against existing pet statistics, and populates the
        pet list with extracted or calculated discounted prices.
        ...
        Notes:
            - Supports pet names with or without quotation marks
            - Handles missing prices by applying a default discount
            - Updates pet list display with imported pet IDs and prices
        """
        text, ok = QInputDialog.getMultiLineText(
            self, "Import PBS Pet Data", "Paste your PBS pet data here:"
        )
